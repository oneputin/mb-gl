    ...
    return (function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            ...
            module.exports = function (e, r, t) {
                var i;
                if ("Feature" === e.type) i = e.geometry.coordinates;
                else {
                    if ("LineString" !== e.type) throw new Error("input must be a LineString Feature or Geometry");
                    i = e.coordinates
                }
                for (var n = 0, a = 0; a < i.length && !(r >= n && a === i.length - 1); a++) {
                    if (n >= r) {
                        var o = r - n;
                        if (o) {
                            var u = bearing(i[a], i[a - 1]) - 180,
                                s = destination(i[a], o, u, t);
                            return s
                        }
                        return point(i[a])
                    }
                    n += measureDistance(i[a], i[a + 1], t)
                }
                return point(i[i.length - 1])
            };
        ...
        3: [function (require, module, exports) {
            ...
            module.exports = function (t, a) {
                var o = Math.PI / 180,
                    ...
                    s = o * h[1],
                    i = o * M[1],
                    c = Math.sin(n - e) * Math.cos(i),
                    d = Math.cos(s) * Math.sin(i) - Math.sin(s) * Math.cos(i) * Math.cos(n - e),
                    u = r * Math.atan2(c, d);
                return u
            };
        ...
        5: [function (require, module, exports) {
            var getCoord = require("@turf/invariant").getCoord,
                radiansToDistance = require("@turf/helpers").radiansToDistance;
            module.exports = function (t, a, r) {
                var o = Math.PI / 180,
                    e = getCoord(t),
                    n = getCoord(a),
                    s = o * (n[1] - e[1]),
                    ...
                    h = o * e[1],
                    M = o * n[1],
                    d = Math.pow(Math.sin(s / 2), 2) + Math.pow(Math.sin(i / 2), 2) * Math.cos(h) * Math.cos(M);
                return radiansToDistance(2 * Math.atan2(Math.sqrt(d), Math.sqrt(1 - d)), r)
            };
        }, {
            "@turf/helpers": 6,
            "@turf/invariant": 7
        ...
        8: [function (require, module, exports) {
            function length(e, t) {
                for (var r, n = 0, o = point(e[0]), i = point(e[0]), u = 1; u < e.length; u++) i.geometry.coordinates = e[u], n += distance(o, i, t), r = o, o = i, i = r;
                return n
            }
            ...
            module.exports = function e(t, r) {
                ...
                var n, o, i = "Feature" === t.type ? t.geometry : t;
                if ("LineString" === i.type) return length(i.coordinates, r);
                if ("Polygon" === i.type || "MultiLineString" === i.type) {
                    for (n = 0, o = 0; o < i.coordinates.length; o++) n += length(i.coordinates[o], r);
                    return n
                }
                if ("MultiPolygon" === t.type) {
                    for (n = 0, o = 0; o < i.coordinates.length; o++)
                        for (var u = 0; u < i.coordinates[o].length; u++) n += length(i.coordinates[o][u], r);
                    return n
                }
        ...
        9: [function (require, module, exports) {
            function coordEach(e, o, t) {
                var r, n, c, l, u, p, i, a, f, s, h = 0,
                    d = "FeatureCollection" === e.type,
                    y = "Feature" === e.type,
                    g = d ? e.features.length : 1;
                for (r = 0; r < g; r++)
                    for (f = d ? e.features[r].geometry : y ? e.geometry : e, s = "GeometryCollection" === f.type, i = s ? f.geometries.length : 1, l = 0; l < i; l++)
                        if (p = s ? f.geometries[l] : f, a = p.coordinates, h = !t || "Polygon" !== p.type && "MultiPolygon" !== p.type ? 0 : 1, "Point" === p.type) o(a);
                        else if ("LineString" === p.type || "MultiPoint" === p.type)
                    for (n = 0; n < a.length; n++) o(a[n]);
                else if ("Polygon" === p.type || "MultiLineString" === p.type)
                    for (n = 0; n < a.length; n++)
                        for (c = 0; c < a[n].length - h; c++) o(a[n][c]);
                else if ("MultiPolygon" === p.type)
                    for (n = 0; n < a.length; n++)
                        for (c = 0; c < a[n].length; c++)
                            for (u = 0; u < a[n][c].length - h; u++) o(a[n][c][u]);
                else {
                    if ("GeometryCollection" !== p.type) throw new Error("Unknown Geometry Type");
                    for (n = 0; n < p.geometries.length; n++) coordEach(p.geometries[n], o, t)
                }
            }

            function coordReduce(e, o, t, r) {
                return coordEach(e, function (e) {
                    t = o(t, e)
                }, r), t
            }

            function propEach(e, o) {
                var t;
                switch (e.type) {
                    case "FeatureCollection":
                        for (t = 0; t < e.features.length; t++) o(e.features[t].properties);
                        break;
                    case "Feature":
                        o(e.properties)
                }
            ...
            function propReduce(e, o, t) {
                return propEach(e, function (e) {
                    t = o(t, e)
                }), t
            }

            function featureEach(e, o) {
                if ("Feature" === e.type) o(e);
                else if ("FeatureCollection" === e.type)
                    for (var t = 0; t < e.features.length; t++) o(e.features[t])
            }
            ...
            module.exports.coordEach = coordEach, module.exports.coordReduce = coordReduce, module.exports.propEach = propEach, module.exports.propReduce = propReduce, module.exports.featureEach = featureEach, module.exports.coordAll = coordAll;

        }, {}],
        10: [function (require, module, exports) {
            var distance = require("@turf/distance");
            module.exports = function (e, r) {
                for (var t, a = 1 / 0, s = 0; s < r.features.length; s++) {
                    var u = distance(e, r.features[s], "miles");
                    u < a && (t = r.features[s], a = u)
                }
                return t
            };
        ...
        11: [function (require, module, exports) {
            function pointOnLine(e, t, r) {
                for (var i = point([1 / 0, 1 / 0], {
                        dist: 1 / 0
                    }), n = 0; n < t.length - 1; n++) {
                    var o = point(t[n]),
                        s = point(t[n + 1]);
                    o.properties.dist = distance(e, o, r), s.properties.dist = distance(e, s, r);
                    var p, d = Math.max(o.properties.dist, s.properties.dist),
                        a = bearing(o, s),
                        u = destination(e, d, a + 90, r),
                        c = destination(e, d, a - 90, r),
                        y = lineIntersects(u.geometry.coordinates[0], u.geometry.coordinates[1], c.geometry.coordinates[0], c.geometry.coordinates[1], o.geometry.coordinates[0], o.geometry.coordinates[1], s.geometry.coordinates[0], s.geometry.coordinates[1]);
                    y && (p = point(y), p.properties.dist = distance(e, p, r)), o.properties.dist < i.properties.dist && (i = o, i.properties.index = n), s.properties.dist < i.properties.dist && (i = s, i.properties.index = n), p && p.properties.dist < i.properties.dist && (i = p, i.properties.index = n)
                }
                return i
            }

            function lineIntersects(e, t, r, i, n, o, s, p) {
                var d, a, u, c, y, g = {
                    x: null,
                    y: null,
                    onLine1: !1,
                ...
                return d = (p - o) * (r - e) - (s - n) * (i - t), 0 === d ? null !== g.x && null !== g.y && g : (a = t - o, u = e - n, c = (s - n) * a - (p - o) * u, y = (r - e) * a - (i - t) * u, a = c / d, u = y / d, g.x = e + a * (r - e), g.y = t + a * (i - t), a > 0 && a < 1 && (g.onLine1 = !0), u > 0 && u < 1 && (g.onLine2 = !0), !(!g.onLine1 || !g.onLine2) && [g.x, g.y])
            }
            var distance = require("@turf/distance"),
                point = require("@turf/helpers").point,
                bearing = require("@turf/bearing"),
            ...
            module.exports = function (e, t, r) {
                ...
                return pointOnLine(t, i, r || "miles")
            };
        }, {
            "@turf/bearing": 3,
            "@turf/destination": 4,
        ...
        12: [function (require, module, exports) {
            ...
            "@turf/bearing": 3,
            "@turf/helpers": 6,
            "@turf/line-distance": 8,
            "@turf/nearest": 10,
            "@turf/point-on-line": 11
        }]
    }, {}, [12])(12)
});